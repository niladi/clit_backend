 ...
 *
 */
public class TranslatorDBpediaToWikipedia extends AbstractSPARQLTranslator {
	private final String SEARCHED_KG_NAMESPACE = "wikipedia.org";
	...
	public String translate(String entity) {
		...
		if (translation == null) {
			...
			return entity.replace("dbpedia.org/resource", "wikipedia.org/wiki");
		} else {
			return translation;
		}
	}
