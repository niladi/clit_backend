 ...
 *
 */
public class AidaLinker extends AbstractLinkerURLPOST {
...
//		}
	...
	@Override
	// TODO This should be resolved by some Abstract class, depending on whether the
	// Linker is used for MD, CG, ED, ...
	// Then this method should be deleted here. Should AidaLinker rather extend e.g.
	// AbstractMentionDetector and not
	// implement the interface MentionDetector?
	public Collection<AnnotatedDocument> execute(final PipelineItem callItem, final AnnotatedDocument document) {
		return null;
//		final Collection<PipelineItem> dependencies = callItem.getDependencies();
