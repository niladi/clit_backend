...
//		}
	...
	public AnnotatedDocument disambiguate(final AnnotatedDocument document) {
		return disambiguate(document, IGNORE_DOUBLED_MENTIONS);
	}
	 ...
	 */
	public AnnotatedDocument disambiguate(final AnnotatedDocument document, final boolean removeDoubledMentions) {
		// Update contexts
		updatePostContext(document.getMentions());
