...
public interface MentionDetector extends PipelineComponent {
	...
	// TODO Do we need this (with param "source")?
	public AnnotatedDocument detect(final AnnotatedDocument document, final String source) throws Exception;

	public default AnnotatedDocument detect(final String text) throws Exception {
