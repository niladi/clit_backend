...
public enum EnumModelType {
	...
	public static EnumModelType getByName(String name) {
		for (EnumModelType e : values()) {
			if (e.root.equals(name)) {
				return e;
			}
		}
		throw new IllegalArgumentException("No task type with name '" + name + "'");
	}
