...
/**
 * Defines what a linker or a pipeline is capable of.
 * Difference to EnumComponentType is that this is defined for a whole pipeline or linker, while the EnumComponentType
 * is defined for a single component (mention detector, splitter, ...) only.
 * 
