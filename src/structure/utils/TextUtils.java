...
public class TextUtils {
	...
	/**
	 * Strip arrow signs (<(...)>) if they are in the beginning and the end of the
	 * entity
	 * 
	 ...
	 */
	public static String stripArrowSigns(final String entity) {
		final int lastOffset = entity.length() - 1;
		if (entity.charAt(0) == arrow_start && entity.charAt(lastOffset) == arrow_end) {
			return entity.substring(1, lastOffset);
		} else {
			return entity;
		}
	}
